	...
	>
		<div class="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
			...
			<p class="mt-6 text-base leading-7 text-gray-300">
				Expert technical assessment for your most important positions
			</p>
			...
			<a
				...
				>Start Vetting Today</a
			>
		</div>
		<div
			class="rounded-3xl rounded-t-3xl bg-white/60 p-8 ring-1 ring-gray-300 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-br-3xl lg:rounded-tl-none shadow-md"
		>
